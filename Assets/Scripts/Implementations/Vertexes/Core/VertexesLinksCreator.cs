...
{
    public class VertexesLinksCreator : LinksCreator<VertexData, VertexView, LinkData<int>, int>
    {
        public VertexesLinksCreator(SmartLinkDataFactory<VertexData, LinkData<int>, int> linkDatasFactory, LinkViewFactory<int> linkViewsFactory,
