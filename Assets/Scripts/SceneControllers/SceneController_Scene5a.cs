...
{
    public class SceneController_Scene5a : SceneControllerBase
    {        
        private DynamicHexesFieldBuilder _fieldBuilder;
        ...
        [Inject]
        public void Construct(DynamicHexesFieldBuilder fieldBuilder, CellDataStorage nodeDatas, CellViewStorage nodeViews,
            CellsConfig config, HexesClickHandler clickHandler, NodeViewSelector<CellView> nodeViewSelector,
        ...
        protected override void InitDefaultStates()
        {
            ...
            _saveLoadPanel.SetInputValues(11, 11);
            _fieldBuilder.CreateNewField(11, 11);
        }
